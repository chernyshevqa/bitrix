course_name = "test"
test_date = {'date_course_name': 'testoviy', 'date_short_name_course': 'test',
             'date_start_course': '15.11.2023', 'date_stop_course': '30.11.2023', 'date_course_version': '1',
             'date_potok': '1',
...
dict_errors = ["Не заполнены обязательные поля:", "Название курса", "Дата старта потока", "Дата конца потока", "Версия курса",
              "Родительский поток", "План лиды", "Минимальное количество участников", "Академических часов", "Дата старта РК"]

date_for_seminar = {'date_seminar_name': 'seminar 1', 'date_module_price': '1000', 'date_module_academic_hour': '10', 'date_module_start_date': '23-11-2023T00:00:00', 'date_module_stop_date': '23-11-2023T01:00:00'
                  ,'date_module_materials_link': 'test_module_materials_link.ru', 'date_address_of_event': 'address_of_event', 'date_module_description': 'module_description',
                  }