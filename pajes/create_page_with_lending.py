...
class Create_new_course_lending(Base):
    ...
    target_course = (By.XPATH, "(//input[@placeholder='Заголовок'])")
    ...
    title_advantages_of_course = (By.XPATH, "(//div[@class='program-item program-item--adv program-item--adv-benefits_program']//input[@placeholder='Заголовок'])")
    text_advantages_of_course = (By.XPATH, "(//div[@class='program-item program-item--adv program-item--adv-benefits_program']//textarea[@placeholder='Текст'])")
    ...
    title_program_suitable = (By.XPATH, "(//div[@class='program-container program-container-program_suitable']//input[@placeholder='Заголовок'])")
    text_program_suitable = (By.XPATH, "(//div[@class='program-container program-container-program_suitable']//textarea[@placeholder='Текст'])")
    ...
    learning_results_title = (By.XPATH, "(//div[@class='learning_outcomes-container']//input[@placeholder='Заголовок'])")
    learning_results_text = (By.XPATH, "(//div[@class='learning_outcomes-container']//textarea[@placeholder='Текст'])")
    ...
    link_viodeofeedback = (By.XPATH,"(//div[@class='program-container program-container-video_reviews']//input[@placeholder='Ссылка'])")
    ...
    conditions_take_part = (By.XPATH, "(//div[@class='program-container program-container-terms_participation']//input[@placeholder='Заголовок'])")
    ...
    filed_of_FIO = (By.XPATH, "(//div[@class='review-item']//input[@placeholder='ФИО'])")
    filed_of_feedback = (By.XPATH, "(//div[@class='review-item']//textarea[@placeholder='Отзыв2'])")
    ...
    def create_new_course(self):
        ...
        self.input(self.course_name, "test")
        time.sleep(2)
        self.click(self.cancel_sending_email)
        self.input(self.short_name_course, "test")
        ...
        self.input(self.target_course, test_date['date_target_course'])
        time.sleep(3)
        ...
        self.input(self.filed_of_FIO, test_date['date_filed_of_FIO'])
        self.input(self.filed_of_feedback, test_date['date_filed_of_feedback'])
        self.select_option_by_visible_text(self.autopay, yes_or_not['Да'])
        self.click(self.button_add_field_advantages_of_course)
        self.input(self.title_advantages_of_course, test_date['date_title_advantages_of_course'])
        self.input(self.text_advantages_of_course, test_date['date_text_advantages_of_course'])
        ...
        self.input(self.title_program_suitable, test_date['date_title_program_suitable'])
        self.input(self.text_program_suitable, test_date['date_text_program_suitable'])
        self.click(self.button_add_learning_results)
        self.input(self.learning_results_title,test_date['date_learning_results'])
        self.input(self.learning_results_text, test_date['date_learning_results'])
        self.input(self.button_add_photo_learning_results, r"D:\testing\Becbt-online\Тестданные\3ce740d01fcc48ac8a3bd42a01ff.jpg")
        self.click(self.button_add_field_videofeedback)
        self.input(self.link_viodeofeedback, test_date['date_link_viodeofeedback'])
        self.click(self.button_conditions_take_part)
        self.input(self.conditions_take_part, test_date['date_conditions_take_part'])
        self.input(self.button_add_photo_feedback, r"D:\testing\Becbt-online\Тестданные\3ce740d01fcc48ac8a3bd42a01ff.jpg")
        ...
        self.input(self.FAQ_text, test_date['date_FAQ_text'])
        self.input(self.FAQ_title, test_date['date_FAQ_title'])
