...
class Create_new_course_page(Base):
    ...
    filed_of_cashback = "//input[@id='kaschback']"
    ...
    def get_sert_group_supervision(self):
        return WebDriverWait(self.driver, 30).until(
            EC.visibility_of_element_located((By.XPATH, self.sert_group_supervision)))
    ...
    def get_promotion(self):
        return WebDriverWait(self.driver, 30).until(
            EC.visibility_of_element_located((By.XPATH, self.promotion)))
    ...
    def get_filed_of_cashback(self):
        return WebDriverWait(self.driver, 30).until(
            EC.visibility_of_element_located((By.XPATH, self.filed_of_cashback)))
    ...
    # def input_search_courses(self):
    #     self.get_course_name().send_keys(self.name_of_course)
    #     print("ввод названия курса в поиске")
    ...
    def input_course_version(self):
        self.get_course_version().send_keys("3")
        print("ввод версии курса")

    def input_potok(self):
        self.get_potok().send_keys("3")
    ...
    def clear_filed(self):
        self.get_discount_member_akpp().send_keys(Keys.ARROW_RIGHT*2)

    def clear_filed_1(self):
        self.get_discount_member_akpp().send_keys(Keys.BACKSPACE*2)

    def input_discount_member_akpp(self):
        self.get_discount_member_akpp().send_keys('11')
    ...
    def input_lead_plan(self):
        self.get_lead_plan().send_keys('11')
    ...
    def input_seminar_attendance_supervision(self):
        self.get_seminar_attendance_supervision().send_keys("10")
    ...
    def input_attendance_ind_supervision_supervision(self):
        self.get_attendance_ind_supervision_supervision().send_keys("10")
    ...
    def input_title_advantages_of_course(self):
        self.get_title_advantages_of_course().send_keys("заголовок преимущества программы")
        print("ввод заголовка преимущества программы")

    def input_text_title_advantages_of_course(self):
        self.get_text_title_advantages_of_course().send_keys("текс преимущества программы")
    ...
    def input_link_video_vizitka(self):
        self.get_link_video_vizitka().send_keys("ссылка на видео визитку")
    ...
    def input_title_program_suitable(self):
        self.get_title_program_suitable().send_keys("заголовок кому подойдёт программа")
        print("ввод заголовка кому подойдёт программа")

    def input_text_program_suitable(self):
        self.get_text_program_suitable().send_keys("текст кому подойдёт программа")
        print("ввод текста кому подойдёт программа")

    def input_learning_results(self):
        self.get_learning_results().send_keys("результаты обучения")
    ...
    def input_link_viodeofeedback(self):
        self.get_link_viodeofeedback().send_keys("ссылка на видеоотзывы")
        print("ввод ссылки на видеоотзывы")

    def input_conditions_take_part(self):
        self.get_conditions_take_part().send_keys("условия участия")
        print("ввод условий участия")

    def input_description_course_speakers(self):
        self.get_description_course_speakers().send_keys("общее описание спикеров курса")
    ...
    def input_filed_of_FIO(self):
        self.get_filed_of_FIO().send_keys("ФИО")
        print("ввод ФИО")

    def input_filed_of_feedback(self):
        self.get_filed_of_feedback().send_keys("отзыв")
        print("ввод отзыва")

    def input_filed_of_cashback(self):
        self.get_filed_of_cashback().send_keys("1")
    ...
    def create_new_course(self):
        ...
        self.input_discount_full_cource()
        ...
        self.input_text_title_advantages_of_course()
